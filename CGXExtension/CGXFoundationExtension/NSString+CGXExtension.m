...
- (NSString *)URLEncode {
    NSCharacterSet *allowedCharacters = [[NSCharacterSet characterSetWithCharactersInString:kCharactersToBeEscapedInQueryString] invertedSet];
...
- (NSURL *)URL {
    ...
    NSString *encodedString = [[self stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]] stringByReplacingOccurrencesOfString:@"+" withString:@"%2B"];
